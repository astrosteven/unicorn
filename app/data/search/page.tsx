            ...
            <div style={{ marginTop: "10px", fontSize: "0.75rem", color: "var(--text-dim)", fontFamily: "'Space Mono', monospace", lineHeight: 1.9 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "1px 16px", color: "var(--text-muted)", marginTop: "8px" }}>
                {([
                  ...
                  ["chia_lowz", "χ² of the low-z (z<7) solution — compare to chia for high-z confidence"],
                  ["int_pz0 … int_pz20", "integrated P(z) in unit-z bins: int_pzN = P(N−0.5 < z < N+0.5); int_pz0 = P(z<0.5)"],
                  ["int_pz9p5_12 / _12_15 / _15_20 / _20_35", "integrated P(z) in the labeled high-z range, e.g. int_pz15_20 = P(15<z<20)"],
                  ["int_zgt1 … int_zgt15", "integrated P(z > n), up to z=35 — e.g. int_zgt10 = P(z>10)"],
                  ["int_cen", "P(z) within ±0.15(1+za) of the best-fit za (peakiness / confidence)"],
                  ["int_zgtza_2", "integrated P(z > za−2) — probability at or above the best fit"],
                  ...
                  ["mass", "log₁₀ stellar mass (Dense Basis: all fields except EGS/COSMOS); mass_16/mass_84 = 16/84th %ile"],
